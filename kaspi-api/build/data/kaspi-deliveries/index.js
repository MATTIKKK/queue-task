...
const kaspi_deliveries_1 = require("../../db/kaspi-deliveries");
    ...
    static saveKaspiDelivery(kaspiDeliveryData) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const existingDelivery = yield kaspi_deliveries_1.KaspiDeliveryModel.findOne({ waybill: kaspiDeliveryData.waybill }).exec();
                if (existingDelivery) {
                ...
                const savedDocument = yield new kaspi_deliveries_1.KaspiDeliveryModel(kaspiDeliveryData).save();
